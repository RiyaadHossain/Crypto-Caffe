...
const CoinDetails = () => {
  ...
  return (
    <div className="px-4 pt-20 pb-28 mx-auto max-w-7xl md:px-5">
      <div className=" grid grid-cols-1 md:grid-cols-2 justify-items-center gap-4 md:justify-items-around content-center">
